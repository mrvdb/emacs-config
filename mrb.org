...
- much better integration of emacs into social systems
  ...
  rest sucks.
** Emacs configuration                                              [1/84]                            :emacs:
:PROPERTIES:
:CATEGORY: Emacs
:END:
...
*** TODO Make the reb-query-replace function permanent
:PROPERTIES:
:CREATED:  [2015-03-23 ma 11:27]
:END:
This function takes a RE-built expression and puts in into a
query-replace-regexp command, which is the 90% case for using it.
