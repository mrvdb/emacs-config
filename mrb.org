...
Last update: <2020-12-04 15:46:06>
...
#+begin_src emacs-lisp
  ...
  (add-hook 'org-agenda-finalize-hook 'beginning-of-buffer 100)
#+end_src
  ...
  ;;(setq mrb/mu4e-path "/home/mrb/dat/src/mail/mu/mu4e")
    ...
    :load-path mrb/mu4e-path
      ...
      :bind (:map mu4e-main-mode-map
                ("q" . (lambda () (interactive) (kill-buffer (current-buffer)))) ; just close the menu
                ("Q" . mu4e-quit)
