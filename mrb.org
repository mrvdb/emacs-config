      ...
      (setq mrb/packages
            (append
             ...
             '(smex ace-jump-mode apache-mode gnuplot-mode sudo-save erc-highlight-nicknames
                    ...
                    flycheck pkg-info perspective ido-vertical-mode jekyll-el jedi elpy org2blog
                    identica-mode php-mode company-mode)
...
#+BEGIN_SRC emacs-lisp
  (setq
     org-babel-interpreters (quote ("emacs-lisp" "python" "ditaa" "sql" "shell" "R" "haskell" "js"))
  )
  ...
  (org-babel-do-load-languages
   ...
   '((R . t) (ditaa . t) (sql . t) (shell . t) (emacs-lisp t) (lisp t)
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key [(super n)] 'mrb/new-empty-buffer)
...
enable company-mode everywhere for everything:
    ...
    (setq
     ...
     (quote
      (autojoin button completion fill
       ...
       readonly replace ring smiley stamp track unmorse
        highlight-nicknames smiley tweet image truncate))
...
#+BEGIN_SRC emacs-lisp
  (setq erc-autojoin-channels-alist
        '((".*\\.freenode.net" "#openobject" "#social" "#bitcoin-nl")))
#+END_SRC
...
For completion in erc, =pcomplete= seems the way to go, but I want to
use company mode everywhere. Until I find the time to write a specific
backend, i'm just going to bind TAB to =company-complete= and be done
with it.
#+BEGIN_SRC emacs-lisp
(define-key erc-mode-map "\t" 'company-complete)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key [(control c) (d)]  'mrb/make-dent-frame)
...
The initialisation of ws-butler as global mode requires however a
client (i.e. X), so enabling the mode is done in [[Client dependent settings]]
