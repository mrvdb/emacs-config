...
This is the only thing needed, after installing an emacs package with GUIX, it is available for requir-ing and can be treated by /straight/ as a /built-in/ type package.
