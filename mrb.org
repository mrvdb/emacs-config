   ...
   (use-package base16-theme
     ...
     (setq base16-adjustments
           '(
             ...
             (notmuch-tag-face  :background "#5e81ac" :foreground "#d8dee9" :box (:line-width 1 :color "#eceff4") :height 0.8)
...
#+BEGIN_SRC emacs-lisp
  (defun mrb/message-mode-hook ()
    ...
    ;; compatible. This happens on encoding.

    ;; Compose part first
    ;; No reflowing without having hard newlines
    ...
    (auto-fill-mode 0)
    ;; Make sure we show the line wrappers in the fringe
    (setq visual-line-fringe-indicators '(nil right-curly-arrow))
    (visual-line-mode 1)
    (setq fill-column 66)
    (visual-fill-column-mode 1)

    ;; Encoding and sending part
    ...
    ;; FIXME: showing f=f is also message mode?
