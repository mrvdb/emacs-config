...
#+begin_src emacs-lisp
  ...
  (use-package ws-butler
    ...
    ;; TODO  why is org-capture-mode in here?
...
#+begin_src emacs-lisp :tangle no
    ...
    (fullframe mu4e--main-view mrb/mu4e-quit)
...
#+begin_src emacs-lisp
  (use-package guix
    ...
    ;; Add yasnippet here, but probably split of later
...
#+begin_src emacs-lisp
  (use-package git-auto-commit-mode
    ...
    :after (org org-journal) ; TODO  race condition as we use an org file to init emacs
    :hook ((org-mode . mrb/git-auto-commit-mode)
           (org-journal-mode . git-auto-commit-mode))
