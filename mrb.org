...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Transitioning to use-package Eventually this sections just needs to
  ;; load use-package, the rest should be distributed with the actual
  ;; configuration of the packages.
  (add-to-list 'load-path "~/dat/src/emacs/packages/use-package/")
  (eval-when-compile
    (require 'use-package))
  ...
  (use-package fixed-point-completion
    :load-path "~/dat/src/emacs/packages/fixed-point-completion/"
    :ensure nil)
...
#+BEGIN_SRC emacs-lisp
  (use-package org-journal
    ...
    :init
    (progn
      (setq org-journal-dir "~/dat/org/journal/")

      (add-to-list 'org-agenda-files org-journal-dir)

      ;; Match the journal files (FIXME: make this relocatable
