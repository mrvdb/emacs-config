...
Last update: <2022-01-15 17:06:14>
...
#+begin_src emacs-lisp
  ...
  (setq use-package-always-ensure nil      ; Make sure this is nil, so we do not use package.el
        ; use-package-always-demand t      ; This 2 should be commented unless debugging
...
The first is the easiest, as the format of =org-todo-keyword-faces= is nigh perfect to transform into a list that cann be used by svg-tag-mode.
...
#+begin_src emacs-lisp
  (use-package org
    :straight (org-mode :branch "release_9.5"
               :includes (org-agenda org-capture org-crypt org-datetree org-protocol))
    :init
    ;; FIXME: this should not be needed, see https://github.com/raxod502/straight.el/issues/536
