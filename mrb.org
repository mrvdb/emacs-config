...
#+BEGIN_SRC emacs-lisp
    ...
    (use-package spaceline-config
      ...
      (setq mrb/cursor-type '(bar . 5))
      (setq evil-normal-state-cursor  `("#bf616a" ,mrb/cursor-type)
            evil-insert-state-cursor  `("#ebcb8b" ,mrb/cursor-type)
            evil-emacs-state-cursor   `("#a3be8c" ,mrb/cursor-type)
            evil-motion-state-cursor  `("#81a1c1" ,mrb/cursor-type)
            evil-visual-state-cursor  `("#8fbcbb" ,mrb/cursor-type)
            evil-replace-state-cursor `("#b48ead" ,mrb/cursor-type))
