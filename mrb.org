...
#+begin_src emacs-lisp
    ...
    (nano-modeline-status ((t ( :background "#5e81ac"))))
...
#+begin_src emacs-lisp
  (use-package message
    ...
    ;; but do not show it in the compose window



    ;; This will have an effect in mu4e starting from 1.11.23
    (setq message-default-mail-headers (mapconcat
                                   'identity
                                        `(,(concat "Bcc: " mrb/bcc-address))
                                   "\n")

          ;; but only show these
          ;; NOTE: message-hidden-headers is automatically set by mu4e-compose-hidden-headers
  ...
  (use-package mu4e
    ...
    (setq
     ...
     mu4e-save-multiple-attachments-without-asking t
       ...
       mu4e-compose-hidden-headers '(not "To:" "From:" "Cc:" "Subject:")
     ;; Context definitions
