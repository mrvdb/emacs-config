...
#+END_SRC
** Scheme
Geiser is a repl for schemes, of which I try to use one, i.e. guile
because it also claims to support emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package magit
    ...
    ;; Work directly on github/gitlab from within magit
    ;; This requires specific authentication stuff, see documentation.
    (use-package magithub
      :config
      (magithub-feature-autoinject t)
      (setq
       magithub-clone-default-directory "~/dat/src/")))
#+END_SRC
