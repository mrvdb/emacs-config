  ...
  (use-package notmuch
    ...
    (progn
      (setq
       ...
       (add-to-list 'auto-mode-alist '("mrb@t510.hsdev.com" . message-mode))
    ))
...
#+BEGIN_SRC emacs-lisp
	...
	;; Emacs bug https://debbugs.gnu.org/cgi/bugreport.cgi?bug=27617 workaround
