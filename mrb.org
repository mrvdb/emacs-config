  ...
  (setq mrb/packages
        (append
         ...
         '(smex ace-jump-mode apache-mode gnuplot-mode sudo-save erc-highlight-nicknames
                ...
                flycheck pkg-info perspective ido-vertical-mode)
...
Secondly, provide some mechanism to group them logically together
...
#+BEGIN_SRC emacs-lisp
  (setq
     org-babel-interpreters (quote ("emacs-lisp" "python" "ditaa" "sql" "sh" "R" "haskell"))
  )
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-publish-project-alist '(
    ("mrblog-org"
            ...
            :base-directory "~/dat/blogs/mrblog/sties/main/org/"
            :base-extension "org"
      ...
      ("mrblog-files"
            :base-directory "~/dat/blogs/mrblog/files/"
