...
Last update: <2022-01-31 10:29:55>
  ...
  (use-package org
    ...
    :straight (org-mode :branch "release_9.5"
        ...
        :hook ((org-mode . turn-on-visual-line-mode)
               (org-mode . turn-on-visusl-fill-column-mode)
...
#+begin_src emacs-lisp
  (use-package weechat
    ...
    :after tracking
    :hook (weechat-mode . visual-line-mode)
    :config
...
#+begin_src emacs-lisp
  (use-package haskell-mode
    :requires ghc
    :hook ((haskell-mode .interactive-haskell)
    ...
    :config
    ;; Replace ⇒ with ⇉ q
    ;; FIXME: i have a global prettifier, can't we use that?
