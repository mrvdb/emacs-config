...
#+begin_src emacs-lisp
  (use-package circe
    ...
    :config
    (setq
     ;; Get just a connection to ZNC for now
     circe-network-options
       `(("HSD"
          :host "chat.hsdev.com" :port 6667
          :nick "mrb"
          :pass ,(concat "mrb@emacs:"
                         (password-store-get "chat.hsdev.com"))
          :channels ("#emacs"
                     "#talos-workstation"
                     "#vikings")))

     ;; Simplify and imporove formatting
     circe-format-say-format-say "{nick:10s}: {body}" ; right align nicks at 10th pos
