  ...
  (use-package base16-theme
    ...
    (setq base16-adjustments
          '(
            ...
            (header-line :foreground base03 :backgorund base0D)))
...
#+BEGIN_SRC emacs-lisp
  (use-package org-journal
    ...
    (add-to-list 'evil-emacs-state-modes 'org-journal-mode))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; - gather functions in minor mode? like org-journal an org-derivative?
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package notmuch
    :after message
    :load-path "~/dat/mail/notmuch/emacs/"
    ...
    (fullframe notmuch-tree-mode notmuch-tree-quit)
