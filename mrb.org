...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package use-package
    ...
    ;; If running as daemon, just load shite to minimize chance of lockup, but it still happens.
    (if (daemonp)
        (setq use-package-always-demand t))

    (use-package use-package-ensure-system-package
      :ensure t							; Need this because we are in use-package config
      )
...
#+BEGIN_SRC emacs-lisp
  (use-package git-auto-commit-mode
    :pin melpa-stable						; Need 4.5.0 to get new files to commit, see issue #20
