...
Last update: <2022-05-14 15:36:50>
...
#+begin_src emacs-lisp
      ...
      (defun mrb/unicode-font-corrections()
        ...
        (mrb/fix-fontset-font "Symbola" #x24C5) ; noto Ⓟ line-height too high
        (mrb/fix-fontset-font "Symbola" #x24c1) ; noto Ⓛ line-height too high
      )
#+end_src
...
#+begin_src emacs-lisp
  (defun mrb/fix-fontset-font ( family from &optional to)
    ...
    (set-fontset-font
     t                                    ; apply to the default mapping
     (cons from (or to from))             ; if to empty, just map to another font
