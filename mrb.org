...
#+BEGIN_SRC emacs-lisp
      ...
      (setq el-get-sources
            '(
              ...
              (:name gnorb                  :type github :pkgname "girzel/gnorb")
              (:name nnreddit               :type github :pkgname "paul-issartel/nnreddit")
              (:name selectric              :type github :pkgname "rbanffy/selectric-mode")
              (:name selected               :type github :pkgname "Kungsgeten/selected.el")
            )
      )
    ...
    (setq mrb/packages
          (append
           ...
           '(smex apache-mode gnuplot-mode sudo-save
                  ...
                  flycheck pkg-info perspective ido-vertical-mode ido-hacks jekyll-el org2blog
                  php-mode company-mode csv-mode notmuch use-package
                  ...
                  pdf-tools hamlet-mode zeal-at-point flycheck-haskell seq)
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; TODO: this is not Haskell specific
  (use-package zeal-at-point)
  (bind-key "s-d" 'zeal-at-point)
  ;;
#+END_SRC
** Python
