...
Last update: <2021-12-07 14:50:59>
...
#+begin_src emacs-lisp
  ;; Use company completion within slime, need to load this first so slime-setup knows
  ...
  (use-package slime
    :after (paredit slime-company)
    ;; Make a local versionn of the proper backends for the slime REPL
    :hook (slime-editing-mode
           . (lambda ()
    ...
    (slime-setup '(slime-fancy slime-banner slime-company slime-asdf))
