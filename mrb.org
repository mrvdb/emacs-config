...
Last update: <2020-11-27 16:07:54>
...
Another step closer to a full terminal replacement is to be able to replace xterml (my terminal emulator in use now). This requires a number of parts:
1. something to call from the commandline instead of xterm
...
The =vterm= brings me some advantages, even close to being able to replace xterm for daily use:
