...
;            (:name metaweblog             :type github :pkgname "punchagan/metaweblog.el")
            ...
            (:name jabber                 :type git    :url     "/home/mrb/dat/src/emacs/packages/jabber.el" :branch "master")
          )
    )
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq user-xmmp-account (concat user-mail-address "/" system-name))
  (setq user-gpg-key (concat "<" user-mail-address ">"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; FIXME: I actually want them, but not in my face
  (setq
...
#+BEGIN_SRC emacs-lisp
  (defun mrb/unicode-font-corrections()
    ...
    ;; TODO: this looks like it can be done more efficiently by using a do-list
    (mrb/fix-fontset-font "Symbola" #x1f3d8) ;; 🏘
    (mrb/fix-fontset-font "Symbola" #x1f3e0) ;; 🏠 house building
    (mrb/fix-fontset-font "Symbola" #x1f3e1) ;; 🏡
    (mrb/fix-fontset-font "Symbola" #x1f435) ;; 🐵 monkey
    (mrb/fix-fontset-font "Symbola" #x1f44d) ;; 👍 thumbs up
    (mrb/fix-fontset-font "Symbola" #x1f4a9) ;; 💩 pile of poo is required
    (mrb/fix-fontset-font "Symbola" #x1f4ac) ;; 💬 chat balloon
    (mrb/fix-fontset-font "Symbola" #x1f4de) ;; 📞 telephone receiver
    (mrb/fix-fontset-font "Symbola" #x1f385) ;; 🎅 santa claus
   )
#+END_SRC
...
(setq org-crypt-key user-gpg-key)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package jabber
    ...
    (progn
      ...
      ;; My accounts
      (setq jabber-account-list (quote ((user-xmmp-account (:connection-type . starttls)))))
