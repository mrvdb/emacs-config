...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key org-mode-map [(control super .)] 'mrb/force-org-todo)
  (define-key org-agenda-mode-map [(control super .)] 'mrb/force-org-agenda-todo)
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key org-mode-map "\C-c\C-e" 'mrb/org-export-body-as-html)
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "\C-xm") 'mrb/make-mailcompose-frame)
...
#+BEGIN_SRC emacs-lisp
  ...
  (eval-after-load "message"
    '(define-key message-mode-map (kbd "TAB") 'mrb/enz-eudc-expand-inline))
  (eval-after-load "sendmail"
    '(define-key mail-mode-map (kbd "TAB") 'mrb/enz-eudc-expand-inline))
  (eval-after-load "post"
    '(define-key post-mode-map (kbd "TAB") 'mrb/enz-eudc-expand-inline))
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key twister-post-mode-map "\C-i" 'company-complete)
#+END_SRC
