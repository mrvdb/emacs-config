...
#+BEGIN_SRC emacs-lisp
  ...
  (defun run-client-settings()
    ...
    (set-face-attribute 'show-paren-match nil :inherit nil :background "gray18" :foreground nil)
  )
...
***** Special keys
For some special keys I have defined some commands
#+BEGIN_SRC emacs-lisp
