...
Last update: <2020-05-15 14:42:48>
  ...
  (use-package company
    ...
    (setq company-idle-delay 0.0
          ...
          (dolist (mode '(python-mode
                          ;; Derived modes apparently not automatic
                          emacs-lisp-mode lisp-interaction-mode lisp-data-mode
                          mu4e-compose-mode))
            (add-to-list 'company-global-modes mode))
