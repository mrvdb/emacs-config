...
#+BEGIN_SRC emacs-lisp
  ;; If I'm understanding this right, this has no adverse
  ;; effects, because I use a local mailserver.
  (setq gnus-asynchronous 1)
...
Now we have gnus running, let's make the summary line to my liking.
#+BEGIN_SRC emacs-lisp
  (setq-default
