    ...
    (use-package base16-theme
      ...
      (setq base16-adjustments
            '(
              ...
              ;; Mu4e
              (mu4e-header-highlight-face :underline nil :foreground nil)))
...
#+begin_src emacs-lisp
  (use-package mu4e
    ...
    (setq
     ...
     mu4e-get-mail-command "mbsync quick"
    ...
    ;; Bind this in the headers an view map
    ;; TODO: how are we not editting a search? e?
    (bind-key "S" 'mu4e-headers-mark-for-spam mu4e-headers-mode-map)
    (bind-key "S" 'mu4e-view-mark-for-spam mu4e-view-mode-map)
