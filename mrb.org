...
Last update: <2021-10-14 14:43:39>
...
#+begin_src emacs-lisp
  ...
  ;; From this point on we should be abale to use `use-package
...
#+begin_src emacs-lisp
  (defun mrb/upgrade-packages ()
    (interactive)
    (message "Rewrite this function to use straight.el"))
...
#+begin_src emacs-lisp
  ...
  (use-package mu4e
    :straight (:includes (org-mu4e mu4e-icalendar))
                               ; dont load from remotes
    ...
    :bind (:map mu4e-main-mode-map
            ...
            :map mu4e-headers-mode-map
                ...
                ("/" . mu4e-headers-search)
            :map mu4e-view-mode-map       ;FIXME: sometimes does not stick/take?
    ...
    (use-package message-view-patch
      ;;FIXME: package is in melpa but straight cant find it?
      :straight (:type git :host github :repo "seanfarley/message-view-patch")
      :config
      (add-hook 'mu4e-view-mode-hook #'message-view-patch-highlight))

    ;; Try to get some more icons in mu4e to spice up the display
    (use-package mu4e-marker-icons
      ;; FIXME: package is on melpa, why not found?
      :straight (:type git :host github :repo "stardiviner/mu4e-marker-icons")
      :init
...
#+begin_src emacs-lisp
      (use-package geiser
        ...
        :straight (:type git :host gitlab :repo "emacs-geiser/geiser")
        :after paredit
        :config
        ; Add implementations to support
        (use-package geiser-guile
          :straight (:type git :host gitlab :repo "emacs-geiser/guile"))
        (use-package geiser-chez
          :straight (:type git :host gitlab :repo "emacs-geiser/chez"))
...
#+begin_src emacs-lisp
  ...
  ;; yaml recipe is missing, and forge depends on it
  (use-package yaml
