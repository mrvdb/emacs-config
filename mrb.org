...
#+BEGIN_SRC emacs-lisp
  ...
  (setq el-get-sources
        '(
          ...
          ;;(:name ethan-wspace :after (progn (global-ethan-wspace-mode 1)))
          (:name erc-hl-nicks           :type elpa)
  ...
  (setq mrb/packages
        (append
         ...
         '(smex ace-jump-mode apache-mode gnuplot-mode sudo-save
                ...
                highlight-parentheses multiple-cursors wrap-region git-modes cl-lib keywiz
                ...
                identica-mode php-mode company-mode xml-rpc csv-mode notmuch use-package)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defvar elfeed-feeds-alist
        '(("http://gdata.youtube.com/feeds/base/users/mvanderboom/newsubscriptionvideos")
          ...
          ("http://feeds.feedburner.com/failblog" humor)
