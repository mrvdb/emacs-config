...
While the /properties/ drawer has an important function while using org, for most of the time when I am entering text, they're mostly in the way. There's a package for that. =org-tidy= hides drawers from view. A marker can be used, but I'm going with invisible.
