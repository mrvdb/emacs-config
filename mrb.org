  ...
  (use-package base16-theme
    ...
    (setq base16-adjustments
        '(;; No underlining for date face in org
          ...
          (show-paren-match             :foreground nil :background base01 :inherit nil :weight normal)
          ;; Set regions so we keep the normal font locking
          (region                       :foreground nil :background base03 :inherit nil :weight normal)
          ;; Magit
          ...
          (flyspell-duplicate           :inherit f:foreground base00 :weight warning)
    ...
    ;; Apply these adjustments in the same way that the theme is defined
    ;; FIME: these should be applied with the client-settings
    ;; Add hook or include in mrb/client-settings?
    ...
    ;; FIXME: try to reuse `base16-set-faces(theme-name colors faces)`
    ;;        for this. It is pretty similar.
    ;; FIXME: if this is the table of all faces we should probably do this at the very end
    (setq mrb/theme-color-map
          '(;; Some non-faces settings
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq mrb-cursor-color "yellow")

  ;; Default frame properties frame position, color, etc
  (setq default-frame-alist
        `((cursor-type . (bar . 1))
          (cursor-color . ,mrb-cursor-color) ;; TODO: this should be redundant (.Xresources has it)
          (height . 60)
          (width . 100)
  ))
...
#+RESULTS:
: ((TODO . mrb/org-todo-keyword-TODO) (DONE . mrb/org-todo-keyword-DONE) (WAITING . mrb/org-todo-keyword-WAITING) (CANCELLED . mrb/org-todo-keyword-CANCELLED) (BUY . mrb/org-todo-keyword-BUY) (HOWTO . mrb/org-todo-keyword-HOWTO) (INFO . mrb/org-todo-keyword-INFO) (COLLECT . mrb/org-todo-keyword-COLLECT) (SOLVE . mrb/org-todo-keyword-SOLVE) (READ . mrb/org-todo-keyword-READ) (PLAN . mrb/org-todo-keyword-PLAN))
