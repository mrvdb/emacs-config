...
Last update: <2022-01-31 15:44:15>
...
#+begin_src emacs-lisp
  ...
  (use-package straight
    :config
    (setq straight-host-usernames '((github . "mrvdb")))
...
#+begin_src emacs-lisp
  (use-package selected
    ...
    :after (org org-journal)              ; List all packages which use this
...
#+begin_src emacs-lisp
  ...
  (bind-key "s-n" #'(lambda () (interactive) (switch-to-buffer (generate-new-buffer "Untitled"))))
