...
#+BEGIN_SRC emacs-lisp
  ...
  (setq el-get-sources
        '(
          ...
          (:name fixed-point-completion :type github
                 :pkgname "smithzvk/fixed-point-completion")
          ...
          (:name git-auto-commit-mode :type github
                 :pkgname "ryuslash/git-auto-commit-mode")
          ...
          (:name org-agenda-property :type github
                 :pkgname "Bruce-Connor/org-agenda-property")
  ...
  (setq mrb/packages
        (append
         ...
         '(smex ace-jump-mode apache-mode gnuplot-mode sudo-save erc-highlight-nicknames
                ...
                flycheck pkg-info perspective ido-vertical-mode jekyll-el)
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'load-path "~/dat/src/emacs/packages/org2blog/")
  (add-to-list 'load-path "~/dat/src/emacs/packages/xml-rpc-el/")
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'load-path  "~/dat/src/emacs/packages/identica-mode")
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'load-path "~/dat/src/emacs/packages/jabber/")
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'load-path "~/dat/src/emacs/packages/jd-el/")
