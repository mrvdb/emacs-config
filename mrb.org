...
Last update: <2022-02-02 17:04:50>
...
#+begin_src emacs-lisp :tangle no
  (setq org-directory "~/dat/org/"
        ...
        org-agenda-text-search-extra-files `('agenda-archives ,(directory-files
...
Now use those bindings too configure both orgmode and org-journal-mode.
...
#+begin_src emacs-lisp :tangle no
  ;; Keygbindings for active regions
...
#+begin_src emacs-lisp
  ...
  (use-package mu4e
    ...
    ;; Configuration for composing mail
    <<mu4e-composeconfig>>
