...
Last update: <2020-12-23 10:31:21>
...
** Searching for items
Over the year the amount of information I manage with orgmode has grown considerably, ranging from the plain TODO lists, blog posts, calendar information, project files etc. Increasingly I find myself not being able to find things in that pile of information. The solution in [[Grepping files]] helps a lot already but is a generic solution.
...
One thing I use this for is in my
...
#+begin_src emacs-lisp
  (use-package helm-ag
    :after helm
    :bind (("C-s-s" . mrb/search))        ; FIXME this is kinda clunky
    :config
