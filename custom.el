...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (url-shortener gist org-mime visual-fill-column mailheader gnuplot ox-epub pdf-tools helm-dash erc-colorize frames-only-mode auth-password-store xterm-keybinder magithub ws-butler erc-hl-nicks zerodark-theme intero atomic-chrome persistent-scratch--autosave-timer persistent-scratch jabber-autoloads oauth jabber ghc ghc-mod ghc-mode smex fixed-point-completion org-journal pass rainbow-mode csv-mode adaptive-wrap)))
